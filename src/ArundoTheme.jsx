...
const ArundoTheme = () => (
  <Container style={{ marginTop: "3em" }}>
    <Header as="h1">Arundo Theme</Header>
    ...
    <Grid columns={3} stackable>
      <Grid.Column>
        <Header as="h1" className="ads-text-display--large">Display 1</Header>
        <Header as="h2">Display 2</Header>
        <Header as="h3">Display 3</Header>
        <Header as="h4">Headline</Header>
